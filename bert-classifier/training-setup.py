...
# clone bert and add to bert-classifier folder
# biobert weights should be in the BERTTOOLS folder
...
df = pd.read_csv("BERTTOOLS/examples.csv")
...
df_bert_train.to_csv('BERTTOOLS/data/train.tsv', sep='\t', index=False, header=False)
df_bert_test.to_csv('BERTTOOLS/data/test.tsv', sep='\t', index=False, header=True)
df.to_csv('BERTTOOLS/data/full_data.csv', sep=',', index=False, header=True)
df_bert_dev.to_csv('BERTTOOLS/data/dev.tsv', sep='\t', index=False, header=False)
